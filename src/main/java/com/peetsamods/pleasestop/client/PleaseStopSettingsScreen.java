...
final class PleaseStopSettingsScreen extends Screen {
    ...
    private ButtonWidget flightAssistButton;
    private ButtonWidget toastsButton;
    ...
    protected void init() {
        ...
        enabledButton = addDrawableChild(ButtonWidget.builder(enabledMessage(), button -> {
        ...
        flightAssistButton = addDrawableChild(ButtonWidget.builder(flightAssistMessage(), button -> {
        ...
        toastsButton = addDrawableChild(ButtonWidget.builder(toastsMessage(), button -> {
